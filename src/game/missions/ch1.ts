...
**Careful** — tempting shortcut: two separate rungs that both write \`OTE(Buzzer)\`. Try it and see what happens…`,
    ...
    objectiveTests: [
      [0],
      [{ test: 1, steps: [2] }, { test: 3, steps: [3] }],
      [{ test: 2, steps: [2] }, { test: 3, steps: [3, 5] }],
      [{ test: 1, steps: [4] }, { test: 2, steps: [4] }, { test: 3, steps: [7] }],
    ],
    concepts: ['XIC', 'OTE'],
...
Tip: one rung can drive two outputs — put a branch around the coils.`,
    ...
    objectiveTests: [
      [{ test: 0, steps: [1] }, { test: 1, steps: [4] }],
      [{ test: 1, steps: [2, 3] }, { test: 2, steps: [3] }],
      [{ test: 0, steps: [2, 3] }, { test: 1, steps: [6, 7, 8] }, { test: 2, steps: [5, 6] }],
    ],
...
\`Light_6\` is ON when **exactly one** of the two switches is ON. Both OFF or both ON = dark.`,
    ...
    objectiveTests: [
      [{ test: 0, steps: [1, 9] }, { test: 1, steps: [7] }],
      [{ test: 0, steps: [3, 7, 11] }, { test: 1, steps: [9] }],
      [{ test: 0, steps: [5, 13] }],
    ],
...
5. **LAMP TEST** — while \`PB_Green\` is held, \`Light_0\`, \`Light_2\` and \`Light_4\` all light
   (so operators can spot a burnt-out lamp). The lamp test must **not** sound the buzzer.`,
    ...
    objectiveTests: [
      [{ test: 0, steps: [1] }, { test: 1, steps: [3, 5, 8, 12, 15] }, { test: 4, steps: [3, 9, 12] }],
      [{ test: 0, steps: [2] }, 2, { test: 4, steps: [13] }],
      [{ test: 0, steps: [3] }, { test: 1, steps: [9, 13] }, { test: 4, steps: [10] }],
      [{ test: 0, steps: [4] }, { test: 1, steps: [2, 6, 10, 17] }, { test: 4, steps: [14] }],
      [3, { test: 4, steps: [5, 7] }],
    ],
    concepts: ['XIC', 'XIO', 'OTE'],
    starter: {
